...
useHead({
  title: `${t('page-title')} - هوشمند پرورش مکران`,
  meta: [
    {
      name: 'robots',
      content: 'noindex',
...
fa:
  page-title: 'صفحه پیدا نشد'
  page-heading: 'صفحه‌ی مورد نظر پیدا نمی‌شود'
  page-body: 'صفحه‌ای که بدنبالش هستید پیدا نمی‌شود. مجدد بررسی نمائید آدرس صحیح می‌باشد یا نه. در صورت وجود اشکال با پشتیبانی تماس بگیرید.'
  back-button: 'بازگشت'
es-MX:
