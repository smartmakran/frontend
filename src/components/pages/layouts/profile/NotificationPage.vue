  ...
  <div class="timeline-wrapper">
    ...
    <div class="timeline-wrapper-inner">
          ...
          <div class="content-wrap">
            <div class="content-box">
              ...
              <div class="box-text">
                <div class="meta-text">
                  <p>
                    <span> الیزابت چرچیل </span> شما را به
                    <a> پروژه طراحی مجدد وب سایت باربر </a> اضافه کرد.
                  </p>
                  <span>11:42 صبح</span>
                </div>
              </div>
          ...
          <div class="content-wrap">
            <div class="content-box">
              ...
              <div class="box-text">
                <div class="meta-text">
                  <p>
                    <span>ریحانه</span> یک دیدگاه در <a>تسک</a> موجود در
                    <a>تغییر نام تجاری ابزارهای شرکتی</a> گذاشت.
                  </p>
                  <span>9:18 صبح</span>
                </div>
              </div>
        ...
        <div class="timeline-item">
          ...
          <div class="content-wrap">
            <div class="content-box">
              ...
              <div class="box-text">
                <div class="meta-text">
                  <p><span>مریم</span> ۳ عضو را به <a>پروژه‌ی شرکت بنفش اضافه کرد</a>.</p>
                  <span>9:18 صبح</span>
                </div>
              </div>
              <div class="box-end">
          ...
          <div class="content-wrap">
            <div class="content-box">
              ...
              <div class="box-text">
                <div class="meta-text">
                  <p>
                    <span>آرنولد اینشتین</span> وضعیت یک <a>تسک</a> را از

                    <VTag label="در انتظار" color="purple" rounded />
                    به
                    <VTag label="اتمام یافته" color="green" rounded /> تغییر داد.
                  </p>
                  <span>9:18 صبح</span>
                </div>
              </div>
        ...
        <div class="timeline-item">
          ...
          <div class="content-wrap">
            <div class="content-box">
              ...
              <div class="box-text">
                <div class="meta-text">
                  <p><span>کریم</span> ۲ فایل به <a>پروژه مورتیمور</a> اضافه کرد.</p>
                  <span>9:18 صبح</span>
                </div>
              </div>
              <div class="box-end">
          ...
          <div class="content-wrap">
            <div class="content-box">
              ...
              <div class="box-text">
                <div class="meta-text">
                  <p>
                    <span>یاسین</span> از شما <a>در یک کامنت</a> مربوط به
                    <a>داشبورد رهگیری مرسولات</a> نام برد.
                  </p>
                  <span>11:42 صبح</span>
                </div>
              </div>
          ...
          <div class="content-wrap">
            <div class="content-box">
              ...
              <div class="box-text">
                <div class="meta-text">
                  <p>
                    <span>الیزابت چرچیل</span> یک دیدگاه در <a>تسک</a> موجود در
                    <a>تغییر نام تجاری ابزارهای شرکتی</a> گذاشت.
                  </p>
                  <span>9:18 صبح</span>
                </div>
          ...
          <div class="content-wrap">
            <div class="content-box">
              ...
              <div class="box-text">
                <div class="meta-text">
                  <p>
                    <span>ملانی</span> وضعیت یک <a>تسک</a> را از
                    <VTag label="معوق" color="danger" rounded />
                    به
                    <VTag label="اتمام یافته" color="green" rounded /> تغییر داد.
                  </p>
                  <span>9:18 صبح</span>
      ...
      <div class="load-more-wrap has-text-centered">
        <VButton dark-outlined>بارگذاری موارد بیشتر</VButton>
      </div>
    </div>
  </div>
</template>
