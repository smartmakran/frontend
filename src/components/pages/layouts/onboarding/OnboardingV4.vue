  ...
  <div class="onboarding-wrapper onboarding-v4">
    <div class="title-wrap">
      ...
      <h2 class="dark-inverted">
        به ویوئِرو خوش آمدید. در وهله اول به چه کاری می‌خواهید بپردازید؟
      </h2>
    </div>
      ...
      <div class="onboarding-wrap-inner">
        ...
        <div class="onboarding-card">
          ...
          <div class="onboarding-content">
            <h3 class="dark-inverted">طرح سفر بریز</h3>
            <p>
              لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از
              طراحان گرافیک است.
            </p>
            <div class="button-wrap">
              <VButton color="primary" rounded elevated> مرور </VButton>
            </div>
          </div>
        </div>
        <!--Card-->
        <div class="onboarding-card">
          ...
          />
          <div class="onboarding-content">
            <h3 class="dark-inverted">هواپیما رزرو کن</h3>
            <p>
              لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از
              طراحان گرافیک است.
            </p>
            <div class="button-wrap">
              <VButton color="primary" rounded elevated> همین الان رزرو کنید </VButton>
            </div>
          </div>
        </div>
        <!--Card-->
        <div class="onboarding-card">
          ...
          />
          <div class="onboarding-content">
            <h3 class="dark-inverted">مرور مقصدهای سفر</h3>
            <p>
              لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از
              طراحان گرافیک است.
            </p>
