<template>
  <div class="standard-onboarding">
    <div class="title-wrap">
      <p>اولین حضورتان را خیر مقدم میگوئیم</p>
      <h2>به ویوئِرو خوش آمدید. در وهله اول به چه کاری می‌خواهید بپردازید؟</h2>
    </div>
      ...
      <div class="onboarding-wrap-inner">
        ...
        <div class="onboarding-card">
          ...
          <div class="button-wrap">
            <VButton color="primary" outlined rounded raised> پیکربندی فروشگاه </VButton>
          </div>
        </div>
        <!--Card-->
        <div class="onboarding-card">
          ...
          <div class="button-wrap">
            <VButton color="primary" outlined rounded raised> مدیریت محصولات </VButton>
          </div>
        </div>
        <!--Card-->
        <div class="onboarding-card">
          ...
          <img
            ...
            alt=""
          />
          <h3>تنظیمات پرداخت‌ها</h3>
          <p>
            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از
            طراحان گرافیک است.
          </p>
          <div class="button-wrap">
            <VButton color="primary" outlined rounded raised> تنظیمات پرداخت‌ها </VButton>
          </div>
        </div>
      </div>
    </div>
