...
const validateStep = async () => {
  if (currentStep.value === 4) {
    ...
    notyf.success('محموله شما با موفقیت ذخیره شد.')
    await sleep(1000)
        ...
        <div v-if="currentStep >= 0" id="form-step-0" class="form-section is-active">
          ...
          <div class="form-section-inner">
            <VField>
              <VControl>
                <input
                  type="text"
                  class="input"
                  placeholder="این محموله مربوط به چیست؟"
                />
              </VControl>
            </VField>
            ...
            <VField>
              <VControl>
                <button class="input-button">
                  ...
                  <span>افزودن گروه حمل و نقل</span>
                </button>
              </VControl>
            </VField>
            ...
            <div class="fieldset">
              <VField grouped>
                <VControl expanded>
                  <input type="text" class="input" placeholder="اسم گروه" />
                </VControl>
                <VControl subcontrol>
                  <VSwitchSegment
                    color="primary"
                    label-true="راهی دیگر"
                    label-false="زمینی"
                  />
                </VControl>
              </VField>
              ...
              <VField grouped>
                <VControl expanded>
                  <input type="text" class="input" placeholder="توضیحات گروه" />
                </VControl>
                <VControl subcontrol>
              ...
              <VField grouped>
                ...
                <VControl subcontrol>
                  <VSwitchSegment label-true="روشن" label-false="خاموش" />
                </VControl>
              </VField>
              ...
              <VField>
                ...
                <VControl>
                  <Multiselect
                    v-model="controlType"
                    :options="['کیفیت X-REF', 'بررسی SERPA', 'بررسی AMF']"
                    placeholder="یک نوع کنترل را انتخاب کنید"
                  />
                </VControl>
              </VField>

              <VField>
                <label>یادداشت های اضافی</label>
                <VControl>
                  <input
                    type="text"
                    class="input"
                    placeholder="چند یادداشت اضافی اضافه کنید"
                  />
                </VControl>
              </VField>
              ...
              <VField>
                ...
                <VControl>
                  <Multiselect
                    ...
                    placeholder="ذخیره سازی را انتخاب کنید"
                  />
                </VControl>
              </VField>
              ...
              <VField>
                ...
                <VControl>
                  <input type="number" class="input" placeholder="مقدار وارد کنید" />
                </VControl>
              </VField>
              ...
              <VField>
                ...
                <VControl>
                  <input
                    type="number"
                    class="input"
                    placeholder="مدت زمان ذخیره سازی را وارد کنید"
                  />
                </VControl>
              </VField>
              ...
              <VField>
                <div class="buttons">
                  <VButton>ارسال را اضافه کنید</VButton>
                </div>
              </VField>
            </div>
          </div>
        ...
        <Transition name="fade-slow">
          <div v-if="currentStep >= 1" id="form-step-1" class="form-section is-active">
            ...
            <div class="form-section-inner">
              <VField>
                <VControl>
                  <input type="text" class="input" placeholder="نام شرکت خود" />
                </VControl>
              </VField>
              ...
              <div class="fieldset">
                <VField grouped>
                  <VControl expanded>
                    <input type="text" class="input" placeholder="نام کامل" />
                  </VControl>
                  <VControl subcontrol>
                    <VSwitchSegment label-true="زمینی" label-false="راهی دیگر" />
                  </VControl>
                </VField>
                ...
                <VField grouped>
                  <VControl expanded>
                    <input type="text" class="input" placeholder="شماره تماس" />
                  </VControl>
        ...
        <Transition name="fade-slow">
          <div v-if="currentStep >= 2" id="form-step-2" class="form-section is-active">
            ...
            <div class="form-section-inner">
              <VField>
                <VControl>
                  <input type="text" class="input" placeholder="دفتر مالیاتی شرکت" />
                </VControl>
              </VField>
                  ...
                  <VField>
                    <VControl>
                      <Multiselect
                        ...
                        :options="['فرم W-12', 'فرم W-12a', 'فرم Z-Form']"
                        placeholder="فرم مالیاتی"
                      />
                    </VControl>
                  </VField>
                </div>
              ...
              <div class="options">
                ...
                <div class="option">
                  ...
                  <div class="option-inner">
                    ...
                    <h4>گزارش بیزینس اینتلیجنس</h4>
                    <p>گزارش سفارشی سازی شده</p>
                  </div>
                </div>
            ...
            <div class="form-section-inner">
              <div class="validation-box">
                <div class="box-content">
                  <h3>عالی</h3>
                  <p>
                    قبل از ارسال فرم ، مطمئن شوید که تمام فیلدهای مورد نیاز را پر کرده
                    اید. پس از ارسال ، نمی توانید اطلاعات این محموله را تغییر دهید.
                  </p>
                </div>
        ...
        <ul v-if="currentHelp === -1" class="steps is-vertical is-thin is-short">
          ...
          >
            ...
            <div class="steps-content">
              <p class="step-number">گام اول</p>
              <p class="step-info">اطلاعات عمومی</p>
            </div>
          </li>
          <li
            id="step-segment-1"
          ...
          >
            <a href="#" class="steps-marker"></a>
            <div class="steps-content">
              <p class="step-number">گام 2</p>
              <p class="step-info">گیرنده مرسوله</p>
            </div>
          </li>
          <li
            id="step-segment-2"
          ...
          >
            <a href="#" class="steps-marker"></a>
            <div class="steps-content">
              <p class="step-number">گام 3</p>
              <p class="step-info">مالیات حمل و نقل</p>
            </div>
          </li>
          <li
            id="step-segment-3"
          ...
          >
            <a href="#" class="steps-marker"></a>
            <div class="steps-content">
              <p class="step-number">گام 4</p>
              <p class="step-info">اختیارات</p>
            </div>
          </li>
          <li
            id="step-segment-4"
          ...
          >
            <a href="#" class="steps-marker"></a>
            <div class="steps-content">
              <p class="step-number">گام 5</p>
              <p class="step-info">اعتبارسنجی</p>
            </div>
          </li>
        </ul>
