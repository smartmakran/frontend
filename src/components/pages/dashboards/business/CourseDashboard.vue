...
<template>
  <div class="business-dashboard course-dashboard">
    <div class="dashboard-title is-main">
      <div class="left">
        <h2 class="dark-inverted">کلاس‌های هفته ششم</h2>
        <p class="h-hidden-mobile">شروع کلاس ها از 6 تا 10 مهر</p>
      </div>
      <div class="right">
        <VButton color="primary" elevated>مشاهده‌ی برنامه‌ی درسی</VButton>
      </div>
    </div>
        ...
        <div v-for="course in courses" :key="course.id" class="column is-4">
          <div class="course-card">
            ...
            <div class="students">
              ...
              <a class="link is-dark-primary">بحث کلاسی</a>
            </div>
            <div class="attached-block">
              <a class="is-dark-primary">رکورد ارائه هفته 6</a>
    ...
    <div class="columns is-multiline tile-grid tile-grid-v2">
      ...
      <div class="column is-4">
        <div class="dashboard-title">
          <div class="left">
            <h2 class="dark-inverted">فایل‌های هفته ششم</h2>
            <p class="h-hidden-mobile">
              فایل‌هایی که این هفته در کلاس‌ها مورد نیاز خواهد بود
            </p>
          </div>
        </div>
          ...
          <div class="tile-grid-item-inner">
            ...
            <div class="meta">
              ...
              <span>
                ...
                <span>آپلود شده {{ file.uploaded }}</span>
              </span>
            </div>
            <FileTileDropdown />
          </div>
      ...
      <div class="column is-8">
        <div class="dashboard-title">
          <div class="left">
            <h2 class="dark-inverted">دانشجویان</h2>
            <p class="h-hidden-mobile">جزئیاتی خلاصه از دانشجویان دوره‌ها</p>
          </div>
          <div class="right">
            <div class="field">
            ...
            <template v-if="column.key === 'picture'">
              ...
              <div>
                ...
                <span class="item-meta">
                  <span>{{ row.progress }}درصد کامل شده</span>
                </span>
              </div>
            </template>
