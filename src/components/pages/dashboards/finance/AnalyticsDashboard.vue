    ...
    <div class="columns">
      <div class="column is-9">
        <div class="columns is-multiline">
          ...
          <div class="column is-4">
            <div class="dashboard-tile">
              <div class="tile-head">
                <h3 class="dark-inverted">ارجاعات</h3>
          ...
          <div class="column is-8">
            <div class="dashboard-card">
              <div class="card-head">
                <h3 class="dark-inverted">عایدی</h3>
              </div>
              <div class="revenue-stats">
                <div class="revenue-stat">
                  <span>این ماه</span>
                  <span class="current">۷۵ میلیون تومان</span>
                </div>
                <div class="revenue-stat">
                  <span>ماه گذشته</span>
                  <span class="dark-inverted">۹۱ میلیون تومان</span>
                </div>
              </div>
              <ApexChart
                id="revenue-chart"
          ...
          <div class="column is-4">
            <div class="dashboard-card">
              <div class="card-head">
                <h3 class="dark-inverted">چشم انداز هدف</h3>
              </div>
          ...
          <div class="column is-4">
            <div class="dashboard-card">
              <div class="card-head">
                <h3 class="dark-inverted">حراجی</h3>
              </div>

              <div class="progress-block">
                <div class="value">
                  <span class="dark-inverted">۷۸درصد</span>
                </div>
          ...
          <div class="column is-8">
            <div class="dashboard-card">
              <div class="card-head">
                <h3 class="dark-inverted">منفعت</h3>
              </div>
              <ApexChart
                id="profit-chart"
                dir="ltr"
      ...
      <div class="column is-3">
          ...
          <template #body>
            <div class="widget-content">
              <p>
                ...
                <span>{{ followersList[2].name }}</span> شما را دنبال می‌کنند. در زمان
        ...
        <UIWidget class="list-widget" straight>
          <template #header>
            <UIWidgetToolbarDropdown title="اعلانات" />
          </template>
          <template #body>
