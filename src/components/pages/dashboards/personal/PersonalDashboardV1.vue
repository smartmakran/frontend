...
<template>
  <div class="personal-dashboard personal-dashboard-v1">
    ...
    <div class="dashboard-header">
      ...
      <div class="start">
        <h3>خوش آمدید، کاربر عزیز</h3>
        <p>از دیدار مجدد شما در پیشخوان اختصاصی خودتان خوش وقت هستیم.</p>
      </div>
      <div class="end">
        <VButton dark="3">مشاهده گزارشات</VButton>
        <VButton color="primary" elevated>مدیریت فروشگاه</VButton>
      </div>
    </div>
      ...
      <div class="columns is-multiline">
        ...
        <div class="column is-6">
          <div class="dashboard-card">
            <h4 class="dark-inverted">خلاصه‌ای از گزارشات</h4>
        ...
        <div class="column is-4">
          <div class="dashboard-card is-upgrade">
            ...
            <div class="cta-content">
              <h4>کاربر عزیز، روز خوبی را برای شما آرزو میکنیم.</h4>
              <p class="white-text">
                از ابزارهای حرفه‌ای و کامل ما به منظور مدیریت وب‌سایت خود بهره ببرید
              </p>
