            ...
            <div class="plan-description">
              ...
              <div class="right">
                <div class="plan-pricing">
                  ...
                  <span> صورتحساب {{ selectedPlan.costs.yearly }} سالانه </span>
                </div>
                <div class="plan-moto">
                  <p>
                    {{ selectedPlan.intro }}
              ...
              <div class="plan-features">
                <div class="columns">
                  <div class="column is-6">
                    <div class="content">
                      <ul>
                        <li>{{ selectedPlan.limits.seats }} نشست</li>
                        <li>{{ selectedPlan.limits.projects }} پروژه</li>
                        <li>{{ selectedPlan.limits.storage }} فضای ذخیره‌سازی</li>
                      </ul>
                    </div>
                  </div>
                  <div class="column is-6">
                    <div class="content">
                      <ul>
                        <li>برزورسانی‌های لحظه‌ای</li>
                        <li>درگاه‌های پرداخت</li>
                        <li>{{ selectedPlan.limits.addons }} افزونه</li>
                      </ul>
                    </div>
                  </div>
                </div>
      ...
      <div class="left">
        ...
        <div class="option-block">
          ...
          <div class="block-body">
            <VSwitchBlock
              v-model="invoces"
              label="فاکتورهای جدید را به صندوق ورودی من ارسال کنید"
              color="primary"
            />
            <VSwitchBlock
              v-model="warnBilling"
              label="قبل از پایان دوره صورتحساب به من هشدار دهید"
              color="primary"
            />
          </div>
        </div>
                ...
                <VField>
                  ...
                  <VControl>
                    <VIMaskInput
                      ...
                      placeholder="کد ۳ یا ۴ رقمی روی کارت"
