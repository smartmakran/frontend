...
en:
  ...
  close-button: 'Close'
fa:
  offline-ready: '{appName} را می‌توان آفلاین نیز استفاده نمود.'
  need-refresh: 'نسخه‌ی جدیدی از {appName} آماده‌ی نصب می‌باشد، بر روی دکمه‌ی تازه‌سازی بزنید تا نصب گردد.'
  reload-button: 'تازه‌سازی'
  close-button: 'ببند'
es-MX:
