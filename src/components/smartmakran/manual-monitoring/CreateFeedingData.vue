...
// feeding data
const feedingSchema = yup.object({
  feedingAmount: yup.number().required('مقدار غذادهی الزامی است'),
  feedingType: yup.string().required('نوع غذادهی الزامی است'),
  feedingDate: yup.date().required('تاریخ مقدار غذادهی الزامی است'),
})
      ...
      <div class="form-outer">
        <div class="form-header">
          <div class="form-header-inner">
            <div class="left">
              <h3>ثبت اطلاعات غذادهی</h3>
            </div>
            <div class="right">
              <div class="buttons">
                <VButton color="primary" @click="createFeedingData" raised>ثبت</VButton>
              </div>
            </div>
          </div>
        </div>
        <div class="form-body">
          ...
          <div class="form-fieldset">
            <div class="columns is-multiline">
              <div class="column is-6">
                <Field v-slot="{ field, errorMessage }" name="feedingAmount">
                  <VField>
                    <label>مقدار غذا</label>
              ...
              <div class="column is-6">
                <Field v-slot="{ field, errorMessage }" name="feedingType">
                  <VField>
                    <label>نوع غذا</label>
                    <VControl :has-error="Boolean(errorMessage)">
                      <input
          ...
          <div class="form-fieldset">
            <div class="columns is-multiline">
              <div class="column is-12">
                <Field v-slot="{ field, errorMessage }" name="feedingDate">
                  <VField>
