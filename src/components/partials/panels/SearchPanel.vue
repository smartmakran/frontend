...
<template>
  <div
    ...
    class="right-panel-wrapper is-search is-right"
  >
    <div
      class="panel-overlay"
      tabindex="0"
    ...
    <div class="right-panel">
      ...
      <div class="right-panel-body has-slimscroll">
        ...
        <div class="recent">
          <h4>اخیرا بازدید شده</h4>
          <div class="recent-block">
            <VBlock title="پشتیبانی مرورگرها" subtitle="مطلب وبلاگی" center>
              <template #icon>
            ...
            <VBlock title="API توئیتر" subtitle="مطلب وبلاگی" center>
              <template #icon>
        ...
        <div class="recent">
          ...
          <div class="recent-block">
            ...
            <VBlock title="جیمی" subtitle="مدیر پروژه" center>
              <template #icon>
                <Tippy
                  class="has-help-cursor"
                  interactive
