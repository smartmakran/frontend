      ...
      <div class="right-panel-body has-slimscroll" data-simplebar>
        <div class="task-group task-overview">
          ...
          <div class="task-description">
            <h4>ساخت صفحه لندینگ موبایل و دسکتاپ</h4>
            <p>
              لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از
              طراحان گرافیک است. ... <a>بیشتر ببینید</a>
            </p>
          </div>
          ...
          <div class="task-files">
            <div class="file-box">
              ...
              <div class="meta">
                <span>طرح اولیه</span>
                <span
                  >3MB <i aria-hidden="true" class="fas fa-circle"></i> 5 روز پیش</span
                >
              </div>
              <FileCardDropdown />
            </div>
            <div class="file-box">
              ...
              <div class="meta">
                ...
                <span
                  >0.6MB <i aria-hidden="true" class="fas fa-circle"></i> 8 روز پیش</span
                >
              </div>
              <FileCardDropdown />
            </div>
            <div class="file-box">
              ...
              <div class="meta">
                <span>نسخه ی نمایشی POC</span>
                <span
                  >8.75MB <i aria-hidden="true" class="fas fa-circle"></i> 8 روز پیش</span
                >
              </div>
              <FileCardDropdown />
            </div>
          ...
          <div class="field has-textarea-addon">
            ...
            <div class="control is-textarea-addon">
              ...
              <div class="end">
                ...
                <a class="button v-button is-primary is-bold is-raised">ارسال</a>
              </div>
            </div>
          </div>
        </div>
