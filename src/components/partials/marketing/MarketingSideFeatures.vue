  ...
  <div class="section">
    <div class="container">
      ...
      <div class="section-title has-text-centered">
        <h2 class="title is-2">محصول کیفیت بالا</h2>
        <h4>ویوئِرو با دقت بالایی در جزئیات ساخته شده است.</h4>
      </div>
      ...
      <div class="columns is-vcentered side-feature">
        ...
        <div class="column is-5">
          <h2 class="title m-b-10 is-centered-tablet-portrait">رابط کاربری باورنکردنی</h2>
