  ...
  >
    ...
    <div class="navbar-menu" :class="[isMobileNavOpen && 'is-active']">
      <div class="navbar-start">
        ...
        <div class="navbar-item">
          <a href="https://docs.vuero.ir" class="nav-link">راهنما</a>
        </div>

        <div class="navbar-item">
          <a href="https://support.vuero.ir" class="nav-link">پشتیبانی</a>
        </div>
      </div>
      ...
      <div class="navbar-end">
        ...
        <div class="navbar-item">
          <RouterLink :to="{ name: 'auth-login-1' }" class="nav-link"> ورود </RouterLink>
        </div>
        <div class="navbar-item">
