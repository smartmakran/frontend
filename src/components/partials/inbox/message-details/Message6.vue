  ...
  >
    <div class="header-area">
      ...
      <div class="message-meta">
        <span class="message-title">گزارش تولید سرب در این ماه</span>
        <span class="sender-email">&lt;irina@vuero.ir&gt;</span>
      </div>
      ...
      <div class="message-inner">
        <div class="message-head">
          <div class="info">
            ...
            <span>18 آبان 1400, در 11:12 صبح</span>
          </div>
        ...
        <div class="mail-content content">
          ...
          <p>
            ...
            <mark>جوابگوی سوالات پیوسته اهل دنیای موجود</mark>
            <mark>طراحی اساسا مورد استفاده قرار گیرد.</mark> شرایط سخت تایپ به پایان رسد
            وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی
          </p>
          <ul>
            <li>جوابگوی سوالات پیوسته اهل دنیای موجود</li>
            <li>
          ...
          <p>
            <a href="http://loripsum.net/">طراحی اساسا مورد استفاده قرار گیرد.</a>
          ...
          <p>هرگاه وقت خواندن آن را داشتید به من اطلاع دهید.</p>
        </div>
