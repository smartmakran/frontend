  ...
  >
    <div class="header-area">
      ...
      <div class="message-meta">
        <span class="message-title"> بررسی مهم پروژه پنجشنبه آینده </span>
        <span class="sender-email">&lt;melany@vuero.ir&gt;</span>
      </div>
      ...
      <div class="message-inner">
        <div class="message-head">
          <div class="info">
            ...
            <span>21 آبان 1400, در 02:33 ب.ظ</span>
          </div>
        ...
        <div class="mail-content content">
          ...
          <p>
            ...
            <strong
              >ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته،</strong
            >
            <em> حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد</em> تا با نرم
            افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ
          ...
          <p>
            <em>چاپگرها و متون بلکه روزنامه و مجله در ستون</em> و سطرآنچنان که لازم است و
            برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود
          </p>
          <p>با خلوص نیت،</p>
          <p>ملانی ولی زاده - بنیانگذار</p>
        </div>
