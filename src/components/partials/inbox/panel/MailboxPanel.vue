...
<template>
  <div class="compose-panel">
    ...
    <div class="header-area">
      <h2 class="panel-title">پیغام جدید</h2>
      <div ref="dropdownElement" class="dropdown inbox-dropdown dropdown-trigger is-left">
        <div>
    ...
    <!--Panel body-->
    <div class="panel-inner has-slimscroll">
      <!--Field-->
      ...
      <div class="field-wrap">
        <div class="field">
          <label class="is-vhidden">پیام:</label>
          <div class="control">
            <textarea
              class="textarea"
              rows="9"
            ...
            ></textarea>
            <button type="button" class="button send-button">ارسال پاسخ</button>
